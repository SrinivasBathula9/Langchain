...
import base64
import os
from vectorsdb import EmbeddingsManager  
...
with st.sidebar:
    ...
    st.image("2-RAG/DocuAssist/logo.png", use_column_width=True)
...
# Home Page
if choice == "🏠 Home":
    st.title("📄 Document Assist")
    st.markdown("""
    Welcome to **Document Assist App**! 🚀
